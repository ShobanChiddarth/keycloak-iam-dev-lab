...
wordlist = []
with open("/usr/share/wordlists/rockyou.txt", "r", encoding="utf-8", errors="ignore") as fh:
...
username=jsmith&password={passwd}&credentialId=
"""
